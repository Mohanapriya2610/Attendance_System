...
spreadsheet_id = "1bo6aY1C8d5jfEQMZ7YIYCrqr2B6eGwnb_dnS3phQXaA"
...
def give_attendance():
    ...
    for email_id in email_ids:
        ...
        sheet.update_cell(email_ids.index(email_id) + 2, 7, mail_sent_time)  # Update the timestamp in column 7
...
def scan_qr_code():
    ...
    if email_id in email_ids:
        ...
        sheet.update_cell(email_ids.index(email_id) + 2, 6, 'yes')  # Update the corresponding cell in the Google Sheet
        sheet.update_cell(email_ids.index(email_id) + 2, 8, timestamp)
